...
const ListNationalOffer = () => {
  ...
  const deleteOffer = async (id) => {
    // fetch(`https://backendapi.trakky.in/salons/national-offers/${id}/`, {
    //   method: "DELETE",
    //   headers: {
    ...
    try {
      ...
      let res = await fetch(
        `https://backendapi.trakky.in/salons/national-offers/${id}/`,
        {
          method: "DELETE",
          headers: {
            Authorization: "Bearer " + `${authTokens.access}`,
  ...
  const handleUpdatePriority = async (id, priority) => {
    try {
      let res = await fetch(
        `https://backendapi.trakky.in/salons/national-offers/${id}/update-priority/`,
        {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
