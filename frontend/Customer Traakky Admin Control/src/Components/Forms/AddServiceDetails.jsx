...
const AddServiceDetails = ({ serviceDetailsData, closeModal, refreshData }) => {
  ...
  useEffect(() => {
    ...
    if (serviceDetailsData) {
      ...
      setSteps(
        serviceDetailsData?.steps?.map((step, index) => ({
          step: step.step,
          instruction: step.instruction,
          ...
          <div className="">
              ...
              <div key={index} className="flex gap-3">
                ...
                <div className="input-box inp-id col-1 col-2 grow">
                  ...
                  <textarea
                    ...
                    onChange={(e) => {
                      const temp = [...steps];
                      temp[index].instruction = e.target.value;
                      setSteps(temp);
                    }}
                ...
                <div className="input-box inp-main-img col-1 col-2">
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      const temp = [...steps];
                      temp[index].image_data = e.target.files[0];
            ...
            <div className="flex justify-center">
              <div
                ...
                disabled={steps[steps.length - 1].instruction === ""}
              >
                + Add Step
              </div>
            </div>
