  ...
  return (
    <div className={styles.HowTrakkyWorks_main_div}>
      <div className={styles.HowTrakkyWorks_content}>
        <p className={styles.HowTrakkyWorks_p1}>
          Get More Customers For Your Salon With Trakky
        </p>
        <div className={styles.HowTrakkyWorks_card}>
            ...
            <div className={styles.HowTrakkyWorks_card_content}>
              ...
              <p className={styles.HowTrakkyWorks_p4}>
                <span style={{ paddingLeft: "5px" }}>
                  <a href="tel:6355167304" className={styles.HowTrakkyWorks_a}>
                    +91 6355167304{" "}
                  </a>
                </span>
                <br />
                <span style={{ paddingLeft: "5px" }}>
                  {" "}
                  <a href="tel:9328382710" className={styles.HowTrakkyWorks_a}>
                    +91 9328382710
                  </a>
                </span>
              </p>
          ...
          <div className={styles.HowTrakkyWorks_ind_card}>
            <div className={styles.HowTrakkyWorks_card_img}>
              <div className={styles.HowTrakkyWorks_image}>
                <img src={photo2} alt="Bussiness Collaboration" />
              </div>
            </div>
            <div className={styles.HowTrakkyWorks_card_content}>
              ...
              <p className={styles.HowTrakkyWorks_p4}>
                Registered your salon on Trakky and get verified
              </p>
            </div>
          </div>
          <div className={styles.HowTrakkyWorks_ind_card}>
            <div className={styles.HowTrakkyWorks_card_img}>
              <div className={styles.HowTrakkyWorks_image}>
                <img
                  src={photo3}
                  alt="Collaborate with Trakky to attract more customers"
                />
              </div>
            </div>
            <div className={styles.HowTrakkyWorks_card_content}>
