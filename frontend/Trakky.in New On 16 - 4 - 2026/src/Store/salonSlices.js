...
import { getTopRatedSalons, getUnisexSalons , getBridalSalons , getKidsSalons ,gettheFemaleBeautySalons , getAcademySalons , getMakeupSalons, getMaleSalons} from '../Components/listPage/pageapi';
  ...
  async ({ category, page, city }, { dispatch, rejectWithValue }) => {
    try {
      ...
      if ( category === 'topRated' ) {
        ...
        response = await gettheFemaleBeautySalons(city ,null, page);
        response.page = page;
        response.city = city;
      }
