...
import AddMembership from "./Forms/AddMembership";
...
const Memberships = () => {
  ...
  const getPackages = async () => {
    ...
    try {
      const response = await fetch(
        `https://backendapi.trakky.in/spas/member-ship/`,
        {
          method: "GET",
          headers: {
  ...
  const deletePackage = async (packageId) => {
    try {
      ...
      const response = await fetch(
        `https://backendapi.trakky.in/spas/member-ship/${packageId}/`,
        {
          method: "DELETE",
          headers: {
            Authorization: "Bearer " + String(authTokens.access),
      ...
      // Handle confirmation rejection separately
      if (error === undefined) {
        // Do nothing if the confirm dialog is canceled
        return;
      }
