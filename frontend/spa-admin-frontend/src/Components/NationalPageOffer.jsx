...
import AddNationalPageOffer from "./Forms/AddNationalPageOffer";
...
const NatioanlPageOffer = () => {
  ...
  const deleteOffer = async (id) => {
    try {
      ...
      let res = await fetch(
        `https://backendapi.trakky.in/spas/national-page-offer/${id}/`,
        {
          method: "DELETE",
          headers: {
...
export default NatioanlPageOffer;
