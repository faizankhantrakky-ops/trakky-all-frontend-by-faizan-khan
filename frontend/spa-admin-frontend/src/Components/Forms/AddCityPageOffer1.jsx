...
const AddCityPageOffer1 = ({ cityOfferData, setCityOfferData }) => {
    ...
    if (cityOfferData) {
      try {
        const response = await fetch(
          `https://backendapi.trakky.in/spas/city-offer-1/${cityOfferData.id}/`,
          {
            method: "PATCH",
            headers: {
      ...
      try {
        const response = await fetch(
          `https://backendapi.trakky.in/spas/city-offer-1/`,
          {
            method: "POST",
            headers: {
              Authorization: "Bearer " + String(authTokens.access),
        ...
        <form method="post" onSubmit={handleSubmit}>
          <div className="row">
            <h3 className="form-title">
              {cityOfferData ? "Update" : "Add"} City Page Offer 1
            </h3>
          </div>
          <div className="row">
...
export default AddCityPageOffer1;
