...
const ListThaiBodyMassage = () => {
  ...
  const handleSearch = async ({ city, area, pageCount }) => {
    let url = `https://backendapi.trakky.in/spas/spa-thai-body-massage/?page=${pageCount}`;
  ...
  const handleUpdatePriority = async (id, priority) => {
    try {
      ...
      let res = await fetch(
        `https://backendapi.trakky.in/spas/spa-thai-body-massage/${id}/update-priority/`,
        {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
...
export default ListThaiBodyMassage;
