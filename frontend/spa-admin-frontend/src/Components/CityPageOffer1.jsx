...
import AddCityPageOffer1 from "./Forms/AddCityPageOffer1";
...
const CityPageOffer1 = () => {
  ...
  const getOffers = async () => {
    try {
      let url = "https://backendapi.trakky.in/spas/city-offer-1/";
  ...
  const deleteOffer = async (id) => {
    try {
      ...
      let res = await fetch(
        `https://backendapi.trakky.in/spas/city-offer-1/${id}/`,
        {
          method: "DELETE",
          headers: {
