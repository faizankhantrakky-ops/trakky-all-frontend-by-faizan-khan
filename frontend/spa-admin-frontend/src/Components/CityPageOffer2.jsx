...
import AddCityPageOffer2 from "./Forms/AddCityPageOffer2";
...
const CityPageOffer2 = () => {
  ...
  const getOffers = async () => {
    try {
      let url = "https://backendapi.trakky.in/spas/city-offer-2/";
  ...
  const deleteOffer = async (id) => {
    try {
      ...
      let res = await fetch(
        `https://backendapi.trakky.in/spas/city-offer-2/${id}/`,
        {
          method: "DELETE",
          headers: {
