...
const PrimaryCityOffers = () => {
  ...
  const deleteOffer = async (id) => {
    try {
      ...
      const response = await fetch(`https://backendapi.trakky.in/salons/salon-city-offer/${id}/`, {
        method: "DELETE",
        headers: {
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                <h1 className="text-xl font-bold text-gray-900">Primary City Offers</h1>
                <p className="mt-1 text-sm text-gray-600">Manage featured city-level salon offers</p>
              </div>
