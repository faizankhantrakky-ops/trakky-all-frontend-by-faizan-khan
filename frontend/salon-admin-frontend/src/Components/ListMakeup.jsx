...
const Makeup = () => {
  ...
  const fetchSalons = async ({ city, area, pageCount }) => {
    let url = `https://backendapi.trakky.in/salons/salon-makeup/?page=${pageCount}`;
  ...
  const handleUpdatePriority = async (id, priority) => {
    try {
      ...
      const res = await fetch(
        `https://backendapi.trakky.in/salons/salon-makeup/${id}/update-priority/`,
        {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
      ...
      <div ref={scrollTopRef} className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-4 font-sans antialiased">
        ...
        <div className="bg-white rounded-t-xl shadow-sm border-b border-gray-200 mb-4">
          <div className="px-6 py-5">
            <h1 className="text-2xl font-bold text-gray-900">Makeup Salons</h1>
            <p className="text-sm text-gray-500 mt-1">
              Manage priority order for makeup salons by city, area or name
            </p>
          </div>
        </div>
            ...
            <div className="relative">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="e.g. Kult Makeup Studio"
                  ...
                  <tr>
                    <td colSpan={6} className="px-6 py-16 text-center text-gray-500">
                      <div className="flex flex-col items-center">
                        ...
                        <p className="text-lg font-medium">No makeup salons match your search</p>
