  ...
  const fetchService = async () => {
    try {
      const response = await axios.get(
        "https://backendapi.trakky.in/salonvendor/service/",
        {
          headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://backendapi.trakky.in/salonvendor/appointments/",
        payload,
        {
          headers: {
            Authorization: `Bearer ${bearerToken}`,
    ...
    <>
      ...
      <div style={{ padding: "10px" }} className="OOBoxFormPOS">
        <div className="outerBoxFormAddAptPOS">
            ...
            <LocalizationProvider dateAdapter={AdapterDayjs}>
              <DemoContainer components={["DatePicker"]}>
                <DatePicker
                  ...
                  onChange={(newValue) => {
                    setDate(newValue ? newValue.format("DD-MM-YYYY") : "");
                  }}
                  format="DD - MM - YYYY"
                  slotProps={{
                    textField: {
          ...
          <span className="IIBoxFormPOS">
            <button className="SubmitbtnAppointment" onClick={handleSubmit}>
              Submit
            </button>
          </span>
        </div>
