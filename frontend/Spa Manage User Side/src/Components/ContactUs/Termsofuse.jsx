...
function Termsofuse() {
  return (
    ...
    <div className={styles.Termsofuse_main}>
      <h1 className=" text-lg font-semibold leading-10">Terms of use by Trakky</h1>
      <p>
      ...
      <p>Phone: - <a href="tel:93283 82710" className={styles.Termsofuse_number}>+91 93283 82710</a></p>
