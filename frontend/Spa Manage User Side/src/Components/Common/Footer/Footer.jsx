  ...
  return (
    <div className="footer__container">
      <div className="footer__main_container">
        <div className="footer__column1">
          ...
          <div className="social_media__container">
            <ul>
              ...
              <li>
                <Link
                  to={
                    "https://api.whatsapp.com/send?phone=916355167304&text=Hi%2C%0AI%27m%20looking%20for%20spa%20services.%20Can%20you%20please%20suggest%20me%20spas%20in%20the%20area%2C%20along%20with%20their%20contact%20information.%0AI%27m%20also%20interested%20to%20get%20offers%20details!%0A%0AI%20am%20waiting%20for%20response.%0A%0AThanks."
                  }
                  target="_blank"
                >
          ...
          <div className=" w-[100%]  text-[.8rem] flex items-center font-semibold customer_care_div ">
            Customer care: <a href="tel:916355167304">+9163551 67304</a>
          </div>
        </div>
        ...
        {/* <div className="footer__column5">
          ...
          <ul>
            <li>
              <Link to={`/${city}/luxuriousspas`}>Best spas</Link>
            </li>

            <li>
              <Link to={`/${city}/topratedspas`}>Top rated</Link>
            </li>
            <li>
              <Link to={`/${city}/luxuriousspas`}>Luxurious</Link>
            </li>
          </ul>
        </div> */}
        <div className="footer__column3">
      ...
      <div className="footer__copyright">
        <p>
          © Copyright 2025 <Link to={"/"}>Trakky</Link>. All Rights Reserved by
