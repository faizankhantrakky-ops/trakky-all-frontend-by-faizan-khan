...
const ProfilepageHeader = ({ handleOpenLogin }) => {
  const { user, authTokens, logoutUser , userData } = React.useContext(authcontext);
  ...
  return (
    <>
      <div className="PPH-contaienr">
        ...
        <div className="trakky-logo"  onClick={() => {
            window.history.back();
          }}>
          <img src={trakk_logo} alt="trakkt logo" />
        </div>
      ...
      >
       <div className=" w-64 min-w-[240px] h-auto px-2 pt-2">
          ...
          <div className=" pt-2 flex w-full items-center h-14">
            <div className=" flex items-center justify-center gap-2 w-2/5 px-2 h-full cursor-pointer"  onClick={() => {
